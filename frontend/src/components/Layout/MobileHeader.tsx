    ...
    <div className="md:hidden pl-1 pt-1 sm:pl-3 sm:pt-3 bg-white shadow-sm">
      <div className="flex items-center justify-between">
        <button
          ...
          className="p-2 rounded-md text-gray-500 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 transition-colors duration-200 cursor-pointer"
        >
        ...
        <div className="flex items-center pr-4">
          ...
          <h1 className="text-lg font-bold text-blue-600">Money Control</h1>
        </div>
      </div>
    </div>
  );
