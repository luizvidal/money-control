            ...
            <div className="mt-12 grid gap-8 grid-cols-1 md:grid-cols-3">
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                  ...
                  <h3 className="text-lg font-medium text-gray-900">Track Transactions</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Easily record and categorize your income and expenses to keep track of where your money is going.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Get a clear overview of your financial health with visual charts and summaries of your spending habits.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                  ...
                  <h3 className="text-lg font-medium text-gray-900">Set Financial Goals</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Create and track progress towards your financial goals, whether it's saving for a vacation or paying off debt.
                  </p>
                </div>
              </div>
            </div>
